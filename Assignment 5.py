    ...
    def dijkstra(self, start):
        ...
        while todo != []:
            ...
            for edge in smallest.edges:
                ...
                print("checking distance to:", edge.to_node.value)
                print("current distance:", edge.to_node.distance)
                print("edge distance:", edge.weight)
                chicken = smallest.distance + edge.weight
                print("possible distance:", chicken)
                if chicken < edge.to_node.distance:
                    # now set it as it is smaller
                    edge.to_node.distance = chicken
        ...
        if not track_prev:
            ...
            for elements in result:
                if elements not in smerf:
                    smerf.append(elements)
